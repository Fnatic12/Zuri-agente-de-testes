...
```bash
python build_index_cli.py --reference-dir reference_images --index-dir artifacts/vector_index --recursive
python classify_cli.py --image path/to/screenshot.png --index-dir artifacts/vector_index --strategy best
python validate_cli.py --image path/to/screenshot.png --index-dir artifacts/vector_index --strategy vote --runs-dir runs --no-llm
```

Top-level convenience entrypoint:

```bash
python visual_qa_cli.py build-index --reference-dir reference_images --index-dir artifacts/vector_index --recursive
python visual_qa_cli.py classify --image path/to/screenshot.png --index-dir artifacts/vector_index --top-k 5 --threshold 0.35 --strategy best
python visual_qa_cli.py validate --image path/to/screenshot.png --index-dir artifacts/vector_index --top-k 5 --threshold 0.35 --strategy vote --runs-dir runs --no-llm
```
...
pip install -r requirements_visual_qa.txt
```
