...
def load_chat_page_config(*, project_root_fn, root_path_fn, resolve_adb_path_fn) -> ChatPageConfig:
    ...
    return ChatPageConfig(
        ...
        ollama_model=os.getenv("CHAT_OLLAMA_MODEL", "llama3.1:8b"),
        ollama_cli=os.getenv("OLLAMA_CLI", "ollama"),
        ollama_num_predict=int(os.getenv("CHAT_OLLAMA_NUM_PREDICT", os.getenv("OLLAMA_NUM_PREDICT", "512"))),
        ollama_temperature=float(os.getenv("CHAT_OLLAMA_TEMPERATURE", os.getenv("OLLAMA_TEMPERATURE", "0.35"))),
        ollama_top_p=float(os.getenv("OLLAMA_TOP_P", "0.9")),
        ollama_num_ctx=int(os.getenv("CHAT_OLLAMA_NUM_CTX", os.getenv("OLLAMA_NUM_CTX", "4096"))),
